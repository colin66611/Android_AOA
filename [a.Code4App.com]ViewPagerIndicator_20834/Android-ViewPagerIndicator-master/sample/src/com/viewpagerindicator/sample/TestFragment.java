...
//		});
    	...
    	btnTvUp.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				if (arg1.getAction() == MotionEvent.ACTION_DOWN)
				{
					...
					Toast.makeText(getActivity(), "µçÊÓÉÏÉý¡£¡£¡£", Toast.LENGTH_SHORT).show();
				...
				if (arg1.getAction()  == MotionEvent.ACTION_UP)
				{
					...
					Toast.makeText(getActivity(), "µçÊÓ¾²Ö¹¡£", Toast.LENGTH_SHORT).show();
    	...
    	btnGlassUp.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				{
					btnTvUp.setImageAlpha(100);
					Toast.makeText(getActivity(), "Ë½ÃÜ²£Á§ÉÏÉý¡£¡£¡£", Toast.LENGTH_SHORT).show();
				...
				{
					btnTvUp.setImageAlpha(255);
					Toast.makeText(getActivity(), "Ë½ÃÜ²£Á§¾²Ö¹¡£", Toast.LENGTH_SHORT).show();
    	...
    	btnTvSwtich.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(true == mIpclServer.mPlc.getTVPwr()) {
					Toast.makeText(getActivity(), "¹Ø±ÕµçÊÓ.", Toast.LENGTH_SHORT).show();
					mIpclServer.mPlc.setTVPwr(false);
				}
				else {
					Toast.makeText(getActivity(), "´ò¿ªµçÊÓ.", Toast.LENGTH_SHORT).show();
    	...
    	btnGlassChange.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(true == mIpclServer.mPlc.getGlassPwr()) {
					Toast.makeText(getActivity(), "¹Ø±Õ²£Á§Îí»¯.", Toast.LENGTH_SHORT).show();
					mIpclServer.mPlc.setGlassPwr(true);
				}
				else {
					Toast.makeText(getActivity(), "²£Á§Îí»¯.", Toast.LENGTH_SHORT).show();
					mIpclServer.mPlc.setGlassPwr(true);
				}
    	...
    	btnTvDown.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				{
					btnTvUp.setImageAlpha(100);
					Toast.makeText(getActivity(), "µçÊÓÏÂ½µ¡£¡£¡£", Toast.LENGTH_SHORT).show();
    	...
    	btnGlassDown.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View arg0, MotionEvent arg1) {
				...
				{
					btnTvUp.setImageAlpha(100);
					Toast.makeText(getActivity(), "Ë½ÃÜ²£Á§ÏÂ½µ¡£¡£¡£", Toast.LENGTH_SHORT).show();
